...
public class CartActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear5l = (LinearLayout) findViewById(R.id.linear5l);
	...
	private void initializeLogic() {
		...
		_radius_to(linear5l, 12, 15, "#FFFFFF");
		_radius_to(linear6, 25, 15, "#dd7755");
		_radius_to(linear9, 12, 15, "#FFFFFF");
		_radius_to(linear10, 25, 15, "#dd7755");
		_radius_to(linear16, 12, 15, "#ffcc11");
	}
